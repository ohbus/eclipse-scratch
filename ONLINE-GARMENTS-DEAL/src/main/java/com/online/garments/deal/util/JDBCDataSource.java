...
public class JDBCDataSource
{
    ...
    public static JDBCDataSource getInstance() {
        if (datasource == null) {
            ...
            datasource.cpds.setJdbcUrl(rb.getString("10.10.1.10:3306/onlinegarmentsdeal"));
            datasource.cpds.setUser(rb.getString("crane_v26"));
            datasource.cpds.setPassword(rb.getString("crane_v26A1"));
